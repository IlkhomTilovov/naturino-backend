        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductCategories_MediaFiles_ImageFileId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OgImageFileId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SEOMetadata_MediaFiles_OgImageFileId",
                        column: x => x.OgImageFileId,
                        principalTable: "MediaFiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_MediaFiles_AvatarFileId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    IsHomePage = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    IsPublished = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    DeletedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NutritionalInfo = table.Column<string>(type: "jsonb", nullable: true),
                    PackagingOptions = table.Column<string>(type: "jsonb", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReplacedByHash = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SEOMetadata_OgImageFileId",
                table: "SEOMetadata",
                column: "OgImageFileId");

            migrationBuilder.CreateIndex(
                name: "IX_Settings_GroupName_Key",
                table: "Settings",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Blogs_MediaFiles_FeaturedImageId",
                table: "Blogs",
                column: "FeaturedImageId",
                principalTable: "MediaFiles",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Certificates_MediaFiles_FileId",
                table: "Certificates",
                column: "FileId",
                principalTable: "MediaFiles",
                principalColumn: "Id",
